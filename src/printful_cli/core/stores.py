...
def get_statistics(transport: SyncTransport, store_id: int, date_from: str,
                   date_to: str,
    ...
    return transport.send(endpoints.get_statistics(
        store_id, date_from, date_to, report_types, currency))


def list_templates(transport: SyncTransport, limit: int = 20,
